...
if (stockCount >= 1) {
  console.log("I'm going to eat some tacos!");
} else {
  console.log("We need to get more tacos");
}
...
if (isFavorite === true) {
  console.log("My favorite food is tacos");
} else {
  console.log("I recently ate tacos");
}
...
var vegetables = ["tomato", "onion", "cactus", "cilantro", "chile"];
...
var fruits = ['mango", "guava", "mamey", "lime", "pear", "papaya", "pineapple"];
